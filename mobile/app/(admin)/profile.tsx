...
export default function AdminProfileScreen() {
  ...
  const menuItems = [
    ...
    },
    {
      ...
      sub: "View all attendance history",
      onPress: () => Alert.alert("Coming Soon", "Coming soon."),
    },
  ];
        ...
        <View style={[s.profileCard, { backgroundColor: C.card, borderColor: C.border }]}>
          ...
          >
            {selectedAvatar !== null ? (
              ...
              <View style={[s.avatar, { backgroundColor: "#8B1A1A" }]}>
                <Text style={s.avatarText}>{getInitials()}</Text>
              </View>
            )}
            <View style={[s.editBadge, { backgroundColor: "#8B1A1A" }]}>
          ...
          <View style={[s.roleBadge, { backgroundColor: C.background, borderColor: "#8B1A1A" }]}>
            <ShieldCheck size={11} color="#8B1A1A" />
            <Text style={[s.roleText, { color: "#8B1A1A" }]}>Administrator</Text>
          </View>
            ...
            <View style={[s.pickerSheet, { backgroundColor: C.card }]}>
                ...
                renderItem={({ item }) => {
                  ...
                  return (
                    <TouchableOpacity
                      style={[
                        s.avatarOption,
                        { borderColor: isActive ? "#8B1A1A" : C.border },
                        isActive && { backgroundColor: C.background },
                      ]}
                      onPress={() => {
                    ...
                    >
                      ...
                      />
                      {isActive && (
                        <View style={[s.avatarCheckBadge, { backgroundColor: "#8B1A1A" }]}>
              ...
              {selectedAvatar !== null && (
                <TouchableOpacity
                  ...
                  onPress={() => { setSelectedAvatar(null); setAvatarPickerOpen(false); }}
                >
        ...
        <View style={[s.card, { backgroundColor: C.card, borderColor: C.border }]}>
          ...
          >
            <View style={s.dropdownLeft}>
              <activeOption.icon size={18} color="#8B1A1A" />
              ...
              {THEME_OPTIONS.map(({ label, value, icon: Icon }) => {
                ...
                return (
                  ...
                  >
                    <View style={[
                      s.dropdownItemIcon,
                      { backgroundColor: isActive ? "#8B1A1A" : C.background },
                    ]}>
                    ...
                    <Text style={[
                      s.dropdownItemText,
                      { color: C.text },
                      isActive && { color: "#8B1A1A", fontWeight: "700" },
                    ]}>
                      {label}
                    </Text>
                    {isActive && (
                      <Check size={16} color="#8B1A1A" style={{ marginLeft: "auto" }} />
                    )}
                  </TouchableOpacity>
                );
              })}
          ...
          {menuItems.map((item, index) => (
            ...
            >
              <View style={[s.menuIconBox, { backgroundColor: C.background }]}>
                <item.icon size={18} color="#8B1A1A" />
              </View>
              <View style={{ flex: 1 }}>
