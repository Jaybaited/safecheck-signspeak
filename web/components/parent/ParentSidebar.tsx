...
const navigation = [
  ...
  { name: 'Notifications', href: '/parent/notifications', icon: Bell, badge: true },
            ...
            return (
              ...
              >
                <div className="relative shrink-0">
                  <Icon className={`w-5 h-5 ${active ? 'text-[#7B1113] dark:text-[#E8C96A]' : 'text-slate-400 dark:text-gray-500 group-hover:text-slate-600 dark:group-hover:text-gray-300'}`} />
                  {showBadge && (
