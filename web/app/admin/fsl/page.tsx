        ...
        <div className="flex justify-between items-center mb-8">
          <div>
            ...
            <p className="text-slate-500 dark:text-gray-400 text-sm">
              Filipino Sign Language recognition tracking and analytics.
            </p>
          </div>
          <ThemeToggle />
        </div>
        ...
        <div className="flex items-center justify-center min-h-[60vh]">
          <div className="bg-white dark:bg-gray-900 border border-slate-200 dark:border-gray-800
            ...
            <p className="text-slate-500 dark:text-gray-400 text-sm leading-relaxed mb-6">
              The FSL Progress dashboard is part of{' '}
              <span className="font-semibold text-[#7B1113] dark:text-[#E8C96A]">Phase 2</span>{' '}
              of SafeCheck-SignSpeak. It will display per-student sign language accuracy,
              letter completion tracking, and AI engagement analytics.
            </p>
